...
<br />
  ...
  <tr valign="top">
    <td height="256"><table  width="100%" cellspacing="0" border="2" bordercolor="#000000">
      <tr bgcolor="#000000">
        <td width="6%" ><div align="center" class="style4">No</div></td>
        <td width="12%" ><div align="center" class="style4">Tanggal</div></td>
        <td width="32%" ><div align="center" class="style4">Catatan</div></td>
        <td width="16%" ><div align="center" class="style4">Transaksi </div></td>
        <td width="18%" ><div align="center" class="style4">Pembayaran</div></td>
        <td width="16%" ><div align="center" class="style4">Saldo</div></td>
      </tr>
      <?
	   ...
	   $no=1; 
	   $sql=mysql_query("SELECT rekap.*, tblpembeli.namapembeli, tblpembeli.perusahaan FROM rekap LEFT JOIN tblpembeli ON rekap.kepada=tblpembeli.idpembeli WHERE tanggal>='$tgl' && tanggal<='$tgl2' && kepada='".$_SESSION['pembeli']."' ORDER BY time ASC");
